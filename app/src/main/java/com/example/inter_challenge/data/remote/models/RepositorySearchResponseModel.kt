...
data class RepositorySearchResponseModel(
    ...
    @SerializedName("owner") var owner: OwnerSearchResponseModel? = null,
    ...
    companion object {
        val dummy = RepositorySearchResponseModel(
            name = "repository-1",
            description = "description-repo-1",
            owner = OwnerSearchResponseModel.dummy,
            stargazersCount = 41242,
            forksCount = 43215
        )
